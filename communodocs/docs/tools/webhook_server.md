# Serveur Webhook GitHub

Voici un exemple de serveur webhook provennant du [cours d'Hugging Face sur les MCP](https://huggingface.co/learn/mcp-course/unit3/github-actions-integration)
