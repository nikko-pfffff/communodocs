Lorsque j'utilise un terminal sous Linux, j'aime bien avoir des informations supplémentaires dans mon invite de commande, comme :

- la branch git sur laquelle je me trouve
- le context kube
- le profile AWS
etc...

Liquidprompt est un outil qui permet de personnaliser l'invite de commande pour afficher ces informations.<br>
